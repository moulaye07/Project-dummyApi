...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    /*
        Fragment d'acceuil de lapplication
    */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*  lorsqu'on clique sur un item (sur un post)
            récupération des donnés, redirection vers une fenêtre (fragment)
            dans laquelle on affiche les données du post sur lequel l'utilisateur a cliqueé
         */
        ...
        postsAdapter.setOnItemLongClickListener {
            ...
            findNavController().navigate(
                R.id.action_mainFragment_to_deletePostFragment,
                bundle
            )
        ...
        val itemTouchHelperCallBack = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                rvNewPosts.adapter?.notifyItemRemoved(position)
                viewModel.newPostsResponse=null
                viewModel.newPostsPage=0
                viewModel.getNewPosts()
        ...
        ItemTouchHelper(itemTouchHelperCallBack).apply {
            attachToRecyclerView(rvNewPosts)
        }
